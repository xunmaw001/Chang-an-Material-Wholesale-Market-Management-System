                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="shopcontractName" name="shopcontractName" class="form-control"
                                               v-model="ruleForm.shopcontractName" readonly>
                                    </div>
                                ...
                                <input id="shanghuId" name="shanghuId" v-model="ruleForm.shanghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>签订时间</label>
                                        <input id="shopcontractTime" name="shopcontractTime" class="form-control"
                                               v-model="ruleForm.shopcontractTime" readonly>
                                    </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "shopcontract/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.shopcontractContent != null && ruleForm.shopcontractContent != 'null' && ruleForm.shopcontractContent != '') {
            var shopcontractContentUeditor = UE.getEditor('shopcontractContentEditor');
                shopcontractContentUeditor.ready(function () {
                    ...
                    shopcontractContentUeditor.setDisabled('fullscreen');
            });
        }
    }
    ...
    function setDownloadBtn() {
        var shopcontractFileUrl = "download('" + ruleForm.shopcontractFile + "')";
        $("#shopcontractFile").attr("onclick", shopcontractFileUrl);
