            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">库房管理</li>
                        <li class="breadcrumb-item active">编辑库房</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 storehouseNameDiv">
                                        <label>库房分区</label>
                                        <input id="storehouseName" name="storehouseName" class="form-control"
                                               placeholder="库房分区">
                                    </div>
                                    <div class="form-group col-md-6 storehouseAddressDiv">
                                        <label>库房地址</label>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("storehouse/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addstorehouse');
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                storehouseName: "required",
                storehouseAddress: "required",
                shanghuId: "required",
            },
            messages: {
                storehouseName: "库房分区不能为空",
                storehouseAddress: "库房地址不能为空",
                shanghuId: "商户不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addstorehouse = window.sessionStorage.getItem("addstorehouse");
        if (addstorehouse != null && addstorehouse != "" && addstorehouse != "null") {
            //注册表单验证
            $(validform());
            ...
            window.sessionStorage.removeItem('updateId');
            http("storehouse/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
