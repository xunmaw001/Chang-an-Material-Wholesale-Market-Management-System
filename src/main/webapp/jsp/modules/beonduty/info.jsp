            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">卫生值班登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>值班日期</label>
                                        <input id="beondutyTime" name="beondutyTime" class="form-control"
                                               v-model="ruleForm.beondutyTime" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="beondutyName" name="beondutyName" class="form-control"
                                               v-model="ruleForm.beondutyName" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.beondutyContent != null && ruleForm.beondutyContent != 'null' && ruleForm.beondutyContent != '') {
            var beondutyContentUeditor = UE.getEditor('beondutyContentEditor');
                beondutyContentUeditor.ready(function () {
                    ...
                    beondutyContentUeditor.setDisabled('fullscreen');
            });
        }
    }
