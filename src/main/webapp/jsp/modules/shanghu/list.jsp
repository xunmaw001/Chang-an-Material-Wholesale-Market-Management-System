...
<!--/Pre Loader -->
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //身份证号
            var shanghuIdNumberCell = document.createElement('td');
            shanghuIdNumberCell.innerHTML = item.shanghuIdNumber;
            row.appendChild(shanghuIdNumberCell);


            //手机号
            var shanghuPhoneCell = document.createElement('td');
            shanghuPhoneCell.innerHTML = item.shanghuPhone;
            row.appendChild(shanghuPhoneCell);


            //邮箱
            var shanghuEmailCell = document.createElement('td');
            shanghuEmailCell.innerHTML = item.shanghuEmail;
            row.appendChild(shanghuEmailCell);

                //照片
            var shanghuPhotoCell = document.createElement('td');
            var shanghuPhotoImg = document.createElement('img');
            var shanghuPhotoImgValue = item.shanghuPhoto;
            if(shanghuPhotoImgValue !=null && shanghuPhotoImgValue !='' && shanghuPhotoImgValue !='null'){
                shanghuPhotoImg.setAttribute('src', shanghuPhotoImgValue);
                shanghuPhotoImg.setAttribute('height', 100);
                shanghuPhotoImg.setAttribute('width', 100);
                shanghuPhotoCell.appendChild(shanghuPhotoImg);
            }else{
                shanghuPhotoCell.innerHTML = "暂无图片";
            }
            row.appendChild(shanghuPhotoCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("shanghu/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addshanghu", "addshanghu");
            window.location.href = "add-or-update.jsp"
        }
        ...
        function resetPassword(id) {
            http("shanghu/resetPassword", "GET",{
                id:id
            }, (res) => {
                if(res.code == 0){
