...
public class ShopcontractView extends ShopcontractEntity implements Serializable {
	...
	public ShopcontractView() {

	}

	public ShopcontractView(ShopcontractEntity shopcontractEntity) {
		try {
			BeanUtils.copyProperties(this, shopcontractEntity);
